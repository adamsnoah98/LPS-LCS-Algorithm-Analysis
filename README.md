...
or another preferred method. Python visualization code is included and requires MatPlotLib. Download this to your classpath
...
LPS is a special case of LCS, where the two input strings are each others reverse. Interestingly, we will see this gives dynamic programming much better execution times for large but limited (<2<sup>24</sup> character) strings.
### Naive Implementation
